...
def command_line():
    ...
    while user_input != 'quit':
        ...
        if user_input == 'clear':
            ...
            print(Fore.BLACK+'   help                 '+Fore.BLUE+'display commands and function (help)')
            print(Fore.BLACK+'   help -cat            '+Fore.BLUE+'display commands and function, formatted into categories (help)')
            print(Fore.BLACK+'   help -des            '+Fore.BLUE+'display command details and an longer description (help)')
            print(Fore.BLACK+'   help -des -cat       '+Fore.BLUE+'display command details and an longer description, formatted into categories (help)')
